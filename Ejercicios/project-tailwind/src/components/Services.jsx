...
const Services = () => {
  return (
    <section className='flex flex-col items-center justify-center py-10 bg-purple-400'>
        {/* Titulo General */}
        <h2 className='mb-10 text-3xl font-bold text-center'>Nuestros Servicios</h2>
        {/* Contenedor de divs */}
